...
!    Collision Frequencies
  ...
  real(kind=8) :: rr_o_p_o_p_m__o2_p_m_5p12ev = 4.7000000000000002E-033
  ...
  real(kind=8) :: rr_op4s_p_o2__o2p_p_o_p_1p55ev_lt = 1.6000000000000001E-017

  ! R13 ! O+(4S) + O2 -> O2+ + O + 1.55 eV if (ti=>900.0) then rr = 9e-18 * ti9m092
  real(kind=8) :: rr_op4s_p_o2__o2p_p_o_p_1p55ev_gt = 8.9999999999999999E-018
  ...
  real(kind=8) :: rr_op2p_p_o2__o2p_p_o_p_6p54ev = 1.2999999999999999E-016

  ! R16 O+(2P) + O2 -> O+(4S) + O2 + 5.016 eV rr = 1.3e-16
  real(kind=8) :: rr_op2p_p_o2__op4s_p_o2_p_5p016ev = 1.2999999999999999E-016
  ...
  real(kind=8) :: rr_o2p_p_e__o1d_p_o1d_p_3p06ev_lt = 1.9500000000000000E-013

  ! R22
  ! O2+ + e -> O(1D) + O(1D) + 3.06 eV if (ti<=1200.0) then rr = 7.39e-14 * te12m056
  ! O2+ + e -> O(3P) + O(1D) + 5.02 eV
  ! O2+ + e -> O(3P) + O(3P) + 6.99 eV
  real(kind=8) :: rr_o2p_p_e__o1d_p_o1d_p_3p06ev_gt = 7.3900000000000006E-014
  ...
  ! rr = 1.0e-17
  real(kind=8) :: rr_op2d_p_o_op4s_p_o3p_p_3p31ev__op4s_p_o1d_p_1p35ev = 1.0000000000000001E-017

  ! R28 ! O+(2D) + e -> O+(4S) + e + 3.31 eV rr = 6.03e-14 * te3m05
  real(kind=8) :: rr_op2d_p_e__op4s_p_e_p_3p31ev =  6.0300000000000006E-014

  ! R29 ! O+(2P) + O -> O+(4S) + O + 5.0 eV rr = 4.0e-16
  real(kind=8) :: rr_op2p_p_o__op4s_p_o_p_5p0ev = 3.9999999999999999E-016

  ! R30 ! O+(2P) + e -> O+(4S) + e + 5.0 eV rr = 3.03e-14 * te3m05
  real(kind=8) :: rr_op2p_p_e__op4s_p_e_p_5p0ev = 3.0300000000000001E-014

  ! R31 ! O+(2P) -> O+(4S) + 2470A   rr = 0.047
  real(kind=8) :: rr_op2p__op4s_p_2470a = 4.7000000000000000E-002
  ...
  real(kind=8) :: rr_op2p_p_e__op2d_p_e_p_1p69ev = 1.8400000000000000E-013
  ...
  real(kind=8) :: rr_op2p__op2d_p_7320a = 0.17100000000000001

  ! R42  ! O+(2D) -> O+(4S) + 3726A  rr = 7.7e-5
  real(kind=8) :: rr_op2d__op4s_p_3726a = 7.7000000000000001E-005
  ...
  ! ! Shunk and Nagy R31
  real(kind=8) :: rr_hep_p_o2__o_p_o_p_he = 9.6999999999999996E-010

  ! R46 ! He+ + e- -> He ( + ??? eV)  rr = 4.8e-12/1.0e6 * te07
  real(kind=8) :: rr_hep_p_em__he =  4.7999999999999997E-012
  ...
  real(kind=8) :: rr_o1d__o3p_p_6300a = 7.1000000000000004E-003

  ! R68  ! O(1D) -> O(3P) + 6364A   rr = 0.0022
  real(kind=8) :: rr_o1d__o3p_p_6364a = 2.2000000000000001E-003

  ! R69 ! O(1D) + e -> O(3P) + e + 1.96 eV  rr = 2.87e-16 * te3m091
  real(kind=8) :: rr_o1d_p_e__o3p_p_e_p_1p96ev = 2.8699999999999998E-016
  ...
  real(kind=8) :: rr_o1d_p_o2__o3p_p_o2_p_1p96ev = 3.2000000000000002E-017

  ! R72 ! O(1D) + O(3P) -> O(3P) + O(3P) + 1.96 eV   rr = 6.47e-18 * ((Tn/300)**0.14)
  real(kind=8) :: rr_o1d_p_o3p__o3p_p_o3p_p_1p96ev = 6.4700000000000002E-018
